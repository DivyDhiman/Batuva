...
public class E_book extends Fragment {
    ...
    private void initialise_view(View root_view) {
        ...
        Adapter_all_view adapter_ebook = new Adapter_all_view(e_book_list.getContext(), data,R.layout.e_book_adapter,getString(R.string.type_e_book));
